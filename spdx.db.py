...
if __name__ == "__main__":
    ...
    if database_type == 'postgres':
        engine = create_engine('postgresql://fossy:fossy@localhost:5432/fossology')
    elif database_type == 'sqlite':
        engine = create_engine('sqlite:///spdx.db', echo=True)
    elif database_type == 'mysql':
        engine = create_engine("mysql+mysqldb://root:my-secret-pw@localhost:3306/spdxdb", isolation_level="READ UNCOMMITTED")
    else:
